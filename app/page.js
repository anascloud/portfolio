...
export default function Home() {
  const { projects, isAddModalOpen, setIsAddModalOpen, isLoggedIn, showLoginDialog } = usePortfolio();
    ...
    <div className="min-h-screen">
      ...
      <section id="projects" className="py-20 px-4 max-w-7xl mx-auto">
        ...
        {filteredProjects.length > 0 ? (
          ...
          <p className="text-center text-slate-500 font-mono">No projects found in this category.</p>
        )}
      </section>
